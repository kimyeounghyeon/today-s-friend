   ...
   <div id="wrapper">
      ...
      <form id="frm">
         ...
         <div>
            ...
            <input type="password" id="pswd1" name="pswd1" class="int" maxlength="20" value="<%=member.getPasswd()%>"> 
         ...
         <div>
            ...
            <input type="password" id="pswd2" name="pswd2" class="int" maxlength="20" value="<%=member.getPasswd()%>">
            </span> <span class="error_next_box"></span>
         </div>
         <!-- NAME -->
         <div>
         ...
         <div>
            ...
            <span class="readbox gender_code"><%=member.getGender()%></span>
         ...
         <div>
            ...
            <input type="text" id="email" name="email"class="int" maxlength="100" placeholder="선택입력" value="<%=member.getEmail()%>">
         ...
         <div>
            ...
            <input type="tel" id="mobile" name="phone" class="int" maxlength="16" placeholder="전화번호 입력" value="<%=member.getPhone()%>">
            </span> <span class="error_next_box"></span>
         </div>
         <!-- JOIN BTN-->
         <div class="btn_area">
