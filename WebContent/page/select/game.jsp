...
%>
		...
		<div id="tool">
			...
			<a id="introducea" class="bar-item button"
				href="javascript:void(window.open('https://www.gamemeca.com/ranking.php', '_blank'))">인기게임순위</a>
			<a id="introduceb" class="bar-item button"
				href="javascript:void(window.open('https://www.youtube.com/watch?v=-GSSZjA1lMQ', '_blank'))">인기영상</a>
