...
<section class="setop">
	...
	<form id="frmAcon">
		<table border="1">
			...
			<tr>
				<td class="td1">제목</td>
				<td class="td2"><input type="text" name="admsubject"
					value="${param.admsubject}" size=100 maxlength=15></td>
			</tr>
			<tr>
				<td class="content2">내용</td>
				<td class="td2"><input type="text" name="admcontent"
					value="${param.admcontent}"
					style="width: 100%; height: 400px; font-size: 15px;"></td>
			</tr>
			<tr>
				<td colspan="2" class="td3">
					<button type="button" id="btnAMod" onclick="ModifyContent();">수정</button>
					<button type="button"
						onclick="window.location='<%=request.getContextPath() %>/page/admin/admboardread';">목록</button>
				</td>
			</tr>
		</table>
		<input type="hidden" name="admno" value="${param.admno}"> <input
