...
/**
 * Servlet implementation class AdReadServlet
 */
@WebServlet("/page/board/adread")
public class AdReadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public AdReadServlet() {
        super();
    }
	...
	private void execute(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/page/board/adboardread.jsp").forward(request,response);
		}
}
